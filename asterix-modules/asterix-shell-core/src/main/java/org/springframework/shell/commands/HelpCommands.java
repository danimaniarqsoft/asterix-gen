...
public class HelpCommands implements CommandMarker, ApplicationContextAware {
	...
	@CliCommand(value = "ayuda", help = "Lista todos los comandos")
	public void obtainHelp(@CliOption(key = { "", "command" }, optionContext = "availableCommands", help = "Nombre del comando para proveer ayuda") String buffer) {
